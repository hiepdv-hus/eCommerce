                    ...
                    <?php $__currentLoopData = $discount_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div>
                            ...
                            <!--<a href="route('product-detail',$product->id)}}">-->
                                ...
                                <div class="ava">
                                    <img width="100" height="100" src="<?php echo e(url('/')); ?>/<?php echo e($product->product_image_intro); ?>">
                                </div>
                                <label class="lbldiscount lbl"><i class="fas fa-bolt"></i>GIẢM <?php echo e(number_format ($product->sale_price,0,'',',')); ?>₫</label>
                                <div class="props">
                                    <span class="dotted">RAM 4 GB</span>
                                    <span class="dotted">Ổ cứng 1TB</span>
                                </div>
