            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 text-center">
                                <a href="<?php echo e(url('facebook/redirect')); ?>">Login With Facebook</a>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                    <a class="btn btn-link" href="<?php echo e(route('changepassword')); ?>">
                            ...
                            <div class="col-md-6 text-right">
                                    <?php if(Route::has('register')): ?>
                                            <a class="btn btn-link" href="<?php echo e(route('register')); ?>"><?php echo e(__('Create account')); ?></a>
                                    <?php endif; ?>
                            </div>
                        </div>
