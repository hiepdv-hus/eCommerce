        ...
        <div class="container-fluid header">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto text-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route ('gio-hang')); ?>">
                    ...
                    <?php if(Session::has('username')): ?>
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <i><img src="<?php echo e(Session::get('avatar')); ?>" width=35px></i>
                                <?php else: ?>
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('dangnhap')); ?>">
                                <i class="fa fa-user"></i>
                                <span class="title"><?php echo e(__('Đăng Nhập')); ?></span>
...
<script type="text/javascript">
    var path = "<?php echo e(route('goiytimkiem')); ?>";
