    ...
    <div>
        ...
        <form class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card-box">
                        <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Sửa user</h5>
                ...
                <div class="col-lg-6">
                    <div class="card-box">
                        <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">Sửa thông tin cá nhân</h5>
...
<div class="card-box">
    ...
    <form enctype="multipart/form-data" action="/" method="post" class="dropzone" id="myAwesomeDropzone">
        <div class="container">
    ...
    export default {
        ...
        methods: {
            ...
            async save(event){
                ...
                {
                    try {
                        let response = await this.systemUser.update();
