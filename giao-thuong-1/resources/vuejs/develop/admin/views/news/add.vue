        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <div class="form-group mb-3">
                        <label for="name">Chọn Danh mục <span class="text-danger">*</span></label>
                        <div class="col-75">
                            <select id="category_id" name="category_id" class="form-control">
                                    <option v-for="category in categorys"
                                            v-bind:value="category.id"
                                        type="text">{{category.name}}</option>
                            </select>
                        </div>
                    </div>
...
<!--                                            <div class="">-->
<!--                                                <button @click.prevent="pickAvatar"-->
<!--                                                        class="btn btn-blue">Tải ảnh lên <diện></diện></button>-->
