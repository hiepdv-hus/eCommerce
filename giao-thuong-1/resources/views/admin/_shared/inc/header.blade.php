        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item" @click="$api.logout()">
            ...
            <a href="index.html" class="logo text-center">
                <span class="logo-lg">
                    <img src="/images/logo-light.png" alt="" height="40">
                     {{--<span class="logo-lg-text-light" style="font-size: 16px; line-height: 40px; position: relative; top: 3px">GEN</span>--}}
                </span>
                <span class="logo-sm">
                     <span class="logo-lg-text-light" style="font-size: 20px">GT</span>
                </span>
            </a>
        </div>
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <i class="mdi mdi-artstation mr-1"></i>
                        <span>Sản phẩm</span>
                    </a>
