 ...
 */
class SystemUserRolePivotEntity extends Entity
{    
    /**
    * const - fields
    */
    const id = 'system_user_role_pivot.id';
    const user_id = 'system_user_role_pivot.user_id';
    const group_id = 'system_user_role_pivot.group_id';
    const user_create_id = 'system_user_role_pivot.user_create_id';
    const user_update_id = 'system_user_role_pivot.user_update_id';
    const is_deleted = 'system_user_role_pivot.is_deleted';
    const created_time = 'system_user_role_pivot.created_time';
    const modified_time = 'system_user_role_pivot.modified_time';
    const primary_key = 'system_user_role_pivot.id';
    const table = '_system_user_role_pivot';
    const table_alias = 'system_user_role_pivot';
    /**
     * Schema
     */
