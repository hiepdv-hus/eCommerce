...
{    
    ...
    */
    ...
    const customer_id = 'contract.customer_id';
    const description = 'contract.description';
    const user_create_id = 'contract.user_create_id';
    const user_update_id = 'contract.user_update_id';
    const is_deleted = 'contract.is_deleted';
    const created_time = 'contract.created_time';
    const modified_time = 'contract.modified_time';
    const primary_key = 'contract.id';
    const table = '_contract';
    const table_alias = 'contract';
    /**
     * Schema
     */
     protected $schema = ['id','customer_id','description','user_create_id','user_update_id','is_deleted','created_time','modified_time'];
    /**
